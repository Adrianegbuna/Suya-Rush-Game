...
class Game:
    ...
    def serve_order(self, quantity=1):
        """Serve up to `quantity` cooked suya to the first waiting customer."""
        ...
        to_serve = min(quantity, ready, customer.remaining_order)
